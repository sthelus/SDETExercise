...
public class ExerciseApproach1 {
    ...
    public static Set<String> getLongestWordAndSize(String inputText) {
        ...
        List<String> wordsInText = new ArrayList(Arrays.asList(inputText.replaceAll("[^A-Za-z\\s]", "").split(" ")));
    ...
    public static void main(String args[]){
        getLongestWordAndSize("Tai Kwon Do Joe in a Tai Kwon Dojo’");
    }
}
